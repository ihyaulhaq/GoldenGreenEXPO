...
public class liat_sukarelawan implements Initializable{

    private Set<StackPane> StroredStack;

    @FXML
    private VBox VboxSukarelawan;
    ...
    private void loadDR() {
        ...
        StroredStack = AppStatus.getStackPane();
    try {
